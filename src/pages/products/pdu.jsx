...
// ── PDU Product Data ──────────────────────────────────────────────────────
// Note: All port/way counts use "Way/Port" terminology — never "Outlets"
...
const pduSeries = [
  {
    ...
    products: [
      { model: 'PDU-8W-10A',  ports: '8-Way', current: '10A', voltage: '100–250V AC', input: 'IEC C14 / C20', output: 'IEC C13 × 8', protection: 'Surge / Fuse', dim: '482×44×60 mm', notes: '1U, horizontal mount, 0.5m inlet cable' },
      { model: 'PDU-8W-16A',  ports: '8-Way', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 8', protection: 'Surge / Fuse', dim: '482×44×60 mm', notes: '1U, 16A heavy-duty version' },
      { model: 'PDU-12W-10A', ports: '12-Way', current: '10A', voltage: '100–250V AC', input: 'IEC C14', output: 'IEC C13 × 12', protection: 'Surge / Fuse', dim: '482×44×80 mm', notes: '1U, extended 12-port layout' },
      { model: 'PDU-12W-16A', ports: '12-Way', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 12', protection: 'Surge / Fuse', dim: '482×44×80 mm', notes: '1U, 16A' },
      { model: 'PDU-16W-16A', ports: '16-Way', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 16', protection: 'Surge / Fuse', dim: '482×44×100 mm', notes: '1U, 16-port high-density' },
      { model: 'PDU-24W-32A', ports: '24-Way', current: '32A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 24', protection: 'Surge / Fuse', dim: '482×44×120 mm', notes: '1U, 32A three-phase compatible' },
    ],
  },
  {
    id: 'metered',
    ...
    subtitle: 'Individual port on/off + LED power metering — 8-Way to 16-Way',
    desc: 'Rackmount PDUs with front-panel LED display for real-time voltage, current, and power (kWh) monitoring. Individual port switching available on selected models. Ideal for data centre power audits and remote power management.',
    products: [
      { model: 'MPDU-8W-10A',  ports: '8-Way', current: '10A', voltage: '100–250V AC', input: 'IEC C14', output: 'IEC C13 × 8', protection: 'Surge + LED meter', dim: '482×44×60 mm', notes: 'Voltage/current display, 0.5m inlet cable' },
      { model: 'MPDU-8W-16A',  ports: '8-Way', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 8', protection: 'Surge + LED meter', dim: '482×44×60 mm', notes: '16A, kWh energy monitoring' },
      { model: 'MPDU-12W-16A', ports: '12-Way', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 12', protection: 'Surge + LED meter', dim: '482×44×80 mm', notes: 'Per-port LED indicator' },
      { model: 'MPDU-16W-32A', ports: '16-Way', current: '32A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 16', protection: 'Surge + LED meter + CB', dim: '482×44×100 mm', notes: '32A, circuit breaker protection, kWh display' },
    ],
  },
  {
    id: 'switched',
    ...
    subtitle: 'Per-port remote on/off switching — IP-enabled management',
    desc: 'Switched PDUs with individual port relay control. Remote power cycling via front-panel button or Ethernet management interface. Suitable for unmanned server rooms and remote site power management.',
    products: [
      { model: 'SPDU-8W-10A',  ports: '8-Way', current: '10A', voltage: '100–250V AC', input: 'IEC C14', output: 'IEC C13 × 8', protection: 'Surge + per-port switch', dim: '482×44×60 mm', notes: 'Physical switch per port, LED status' },
      { model: 'SPDU-8W-16A',  ports: '8-Way', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 8', protection: 'Surge + per-port switch', dim: '482×44×60 mm', notes: '16A per-port switching' },
      { model: 'SPDU-16W-16A', ports: '16-Way', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 16', protection: 'Surge + per-port switch + LED meter', dim: '482×44×100 mm', notes: 'Full metering + switching' },
    ],
  },
  {
    id: 'vertical',
    ...
    subtitle: 'Side-mount vertical installation — does not occupy rack U-space',
    ...
    products: [
      { model: 'VPDU-12P-16A',  ports: '12-Port', current: '16A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 12', protection: 'Surge + CB', dim: '1730×52×52 mm', notes: '0U vertical, fits standard 42U racks' },
      { model: 'VPDU-20P-32A',  ports: '20-Port', current: '32A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 16 + C19 × 4', protection: 'Surge + CB', dim: '1730×52×52 mm', notes: '0U vertical, mixed C13/C19' },
      { model: 'VPDU-24P-32A',  ports: '24-Port', current: '32A', voltage: '100–250V AC', input: 'IEC C20', output: 'IEC C13 × 20 + C19 × 4', protection: 'Surge + CB + LED meter', dim: '1730×52×52 mm', notes: '0U vertical, full metering, 24-port high-density' },
    ],
  },
]

const specCols = ['Model', 'Ports', 'Current Rating', 'Voltage', 'Input Connector', 'Output', 'Protection', 'Dimensions', 'Notes']
    ...
    >
      ...
      <section style={{ padding: '80px 0 60px', background: '#1a1f2e', borderBottom: '1px solid #2e3648' }}>
        <div className="container">
          <div style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#e8a020', marginBottom: 12 }}>
            Products / PDU
          </div>
          <nav style={{ fontSize: '0.82rem', color: '#4a5568', marginBottom: 24 }}>
            <Link href="/" style={{ color: '#4a5568' }}>Home</Link> › <Link href="/products/" style={{ color: '#4a5568' }}>Products</Link> › Power Distribution Units
          </nav>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            {['8-Way to 24-Way', 'IEC C13 / C19', 'Metered & Switched', '0U Vertical Option', 'OEM / ODM'].map(b => (
        ...
        <div className="container" style={{ display: 'flex', gap: 0 }}>
          {pduSeries.map(s => (
            <a key={s.id} href={`#${s.id}`} style={{
              padding: '16px 20px', fontSize: '0.82rem', fontWeight: 600,
              color: '#8a94a6', whiteSpace: 'nowrap', borderBottom: '2px solid transparent', display: 'block'
            }}
              onMouseEnter={e => { e.target.style.color = '#e8a020'; e.target.style.borderBottomColor = '#e8a020' }}
              onMouseLeave={e => { e.target.style.color = '#8a94a6'; e.target.style.borderBottomColor = 'transparent' }}
            >{s.tag}</a>
          ))}
        </div>
      </section>
          ...
          <div className="container">
            ...
            <div style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
                ...
                <tbody>
                  {s.products.map((p, i) => (
                    <tr key={p.model} style={{ background: i % 2 === 0 ? '#252b3b' : '#1e2535', borderBottom: '1px solid #2e3648' }}>
      ...
      {/* Standards & Compatibility Note */}
      <section style={{ background: '#111520', padding: '60px 0', borderBottom: '1px solid #2e3648' }}>
        <div className="container">
          <h2 style={{ fontSize: '1.2rem', fontWeight: 700, color: '#e8eaf0', marginBottom: 24 }}>Standards & Compatibility</h2>
      ...
      <section style={{ background: '#0d1117', padding: '80px 0', borderTop: '1px solid #2e3648' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#e8a020', marginBottom: 12 }}>Custom Orders</div>
