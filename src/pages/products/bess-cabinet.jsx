...
// ── BESS Cabinet Product Data ─────────────────────────────────────────────
// Specs based on standard industrial BESS enclosure configurations.
// Lucas to verify / update with factory spec sheets before go-live.
...
const bessSeries = [
  {
    ...
    products: [
      { model: 'BESS-50kWh-OD',  capacity: '50 kWh',  dims: '800×1000×1900 mm', steel: 'SPCC 2.0mm', ip: 'IP54', thermal: 'Natural ventilation', finish: 'Epoxy powder, RAL 7035', notes: 'Single-door, 1×50kWh module bay' },
      { model: 'BESS-100kWh-OD', capacity: '100 kWh', dims: '1000×1000×2100 mm', steel: 'SPCC 2.0mm', ip: 'IP54', thermal: 'Forced ventilation (fans)', finish: 'Epoxy powder, RAL 7035', notes: 'Double-door, 2×50kWh module bays' },
      { model: 'BESS-200kWh-OD', capacity: '200 kWh', dims: '2000×1000×2200 mm', steel: 'SPCC 2.0mm', ip: 'IP54', thermal: 'Forced ventilation + thermostat', finish: 'Epoxy powder, RAL 7035', notes: '4×50kWh module bays, cable tray integrated' },
    ],
  },
  {
    id: 'container-bess',
    ...
    products: [
      { model: 'BESS-500kWh-CT',  capacity: '500 kWh',   dims: '6058×2438×2591 mm (20ft)', steel: 'SPCC 3.0mm + structural frame', ip: 'IP54', thermal: 'HVAC interface (customer-supplied)', finish: 'RAL 9005 black / custom', notes: 'ISO 20ft frame compatible, 10×50kWh bays' },
      { model: 'BESS-1MWh-CT',    capacity: '1 MWh',     dims: '12192×2438×2591 mm (40ft)', steel: 'SPCC 3.0mm + structural frame', ip: 'IP54', thermal: 'HVAC interface (customer-supplied)', finish: 'RAL 9005 black / custom', notes: 'ISO 40ft frame, 20×50kWh bays, PCS interface panel' },
    ],
  },
  {
    id: 'indoor-bess',
    ...
    desc: 'Wall-mount and freestanding indoor BESS enclosures for commercial and C&I applications. Designed for LiFePO₄ and NMC module integration. Includes bus-bar compartment, BMS wiring tray, and lockable front access panel.',
    products: [
      { model: 'BESS-10kWh-IN',  capacity: '10 kWh',  dims: '600×600×1200 mm', steel: 'SPCC 1.5mm', ip: 'IP20', thermal: 'Passive / side vents', finish: 'Powder coat, RAL 7016', notes: 'Freestanding, 1×10kWh module bay, BMS compartment' },
      { model: 'BESS-20kWh-IN',  capacity: '20 kWh',  dims: '600×700×1600 mm', steel: 'SPCC 1.5mm', ip: 'IP20', thermal: 'Passive + optional fan tray', finish: 'Powder coat, RAL 7016', notes: 'Freestanding, 2×10kWh bays' },
      { model: 'BESS-WM-5kWh',   capacity: '5 kWh',   dims: '600×250×900 mm',  steel: 'SPCC 1.2mm', ip: 'IP20', thermal: 'Passive', finish: 'Powder coat, white/black', notes: 'Wall-mount, residential / small C&I' },
    ],
  },
]

const bessCols = ['Model', 'Capacity', 'Dimensions (W×D×H)', 'Steel Gauge', 'IP Rating', 'Thermal Management', 'Finish', 'Notes']

const techHighlights = [
  {
    icon: '⬛',
    title: 'SPCC Cold-Rolled Steel',
    desc: '1.2–3.0mm SPCC structural steel. CNC laser-cut, precision-bent to ±0.5mm tolerance. No brittle weld seams on load-bearing panels.',
  },
  {
    icon: '🔒',
    title: 'IP54 / IP65 Rating',
    desc: 'Dust-tight and splash-proof gasket sealing on all door frames and cable entry glands. Certified test reports available for procurement.',
  },
  {
    icon: '🎨',
    title: 'In-House Powder Coating',
    desc: 'Electrostatic powder coat in any RAL colour. 80–100μm film thickness, salt-spray tested to 500 hours. Suitable for coastal and desert environments.',
  },
  {
    icon: '🔧',
    title: 'OEM / ODM Engineering',
    desc: 'Custom bus-bar layout, cable entry patterns, BMS compartment sizing, and branding. DXF drawing review within 5 business days.',
  },
  {
    icon: '📋',
    title: 'Documentation Package',
    desc: 'Material certificates (SPCC mill certificates), coating thickness reports, dimensional inspection reports, and packing list per shipment.',
  },
  {
    icon: '🌍',
    title: 'Export Experience',
    desc: 'Shipped to Middle East, Africa, Southeast Asia, and Europe. FCL and LCL consolidation. CIF / FOB / EXW terms available.',
  },
]
  ...
  return (
    ...
    >
      ...
      <section style={{ padding: '80px 0 60px', background: '#1a1f2e', borderBottom: '1px solid #2e3648' }}>
        <div className="container">
          <div style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#e8a020', marginBottom: 12 }}>
            Products / BESS Cabinets
          </div>
          <nav style={{ fontSize: '0.82rem', color: '#4a5568', marginBottom: 24 }}>
            <Link href="/" style={{ color: '#4a5568' }}>Home</Link> › <Link href="/products/" style={{ color: '#4a5568' }}>Products</Link> › BESS Cabinets
          </nav>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            {['SPCC 2.0–3.0mm Steel', 'IP54 / IP65 Rated', 'ISO Container Compatible', '10 kWh – 1 MWh+', 'OEM / ODM'].map(b => (
                  ...
                  {s.products.map((p, i) => (
                    <tr key={p.model} style={{ background: i % 2 === 0 ? '#252b3b' : '#1e2535', borderBottom: '1px solid #2e3648' }}>
                      ...
                      <td style={{ padding: '14px 16px' }}>
                        <span style={{ display: 'inline-block', padding: '3px 10px', background: 'rgba(232,160,32,0.12)', color: '#e8a020', borderRadius: 2, fontSize: '0.82rem', fontWeight: 700 }}>{p.ip}</span>
                      </td>
      ...
      <section style={{ background: '#111520', padding: '80px 0', borderBottom: '1px solid #2e3648' }}>
        <div className="container">
          <div style={{ marginBottom: 40 }}>
            <div style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#e8a020', marginBottom: 8 }}>Manufacturing Capability</div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
            {techHighlights.map(h => (
              <div key={h.title} style={{ background: '#1a1f2e', border: '1px solid #2e3648', padding: '28px', borderTop: '3px solid #e8a020' }}>
                <div style={{ fontSize: '1.5rem', marginBottom: 12 }}>{h.icon}</div>
      ...
      <section style={{ background: '#0d1117', padding: '80px 0', borderTop: '1px solid #2e3648' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'center' }}>
          <div>
            <div style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#e8a020', marginBottom: 12 }}>Project RFQ</div>
