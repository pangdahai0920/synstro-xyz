      ...
      <section style={{ padding: '60px 0', background: '#1a1f2e' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(280px, 460px) 1fr', gap: 48, alignItems: 'start' }} className="detail-grid">
            ...
            {/* LEFT — product image (click to enlarge) */}
            <div
            ...
            >
              ...
              <span style={{
                ...
                fontSize: '0.7rem', color: '#4a5568', fontWeight: 600,
                letterSpacing: '0.06em', pointerEvents: 'none',
              }}>
                CLICK TO ENLARGE
              </span>
            </div>
            {lightbox && <Lightbox src={product.image} alt={product.model} onClose={closeLightbox} />}
