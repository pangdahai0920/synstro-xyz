...
// ── Product Data (from EXW Quotation List) ───────────────────────────────
...
const series = [
  {
    ...
    products: [
      ...
      { model: 'WN-6U',  size: '520×400×300 mm', volume: '0.016 CBM', material: 'SPCC 0.5–0.8mm', door: 'Tempered Glass / Perforated', color: 'Black / Grey-White', notes: 'Shelf ×1 included' },
      { model: 'WN-9U',  size: '520×400×450 mm', volume: '0.017 CBM', material: 'SPCC 0.5–0.8mm', door: 'Tempered Glass / Perforated', color: 'Black / Grey-White', notes: 'Shelf ×1 included' },
      { model: 'WN-12U', size: '520×400×600 mm', volume: '0.034 CBM', material: 'SPCC 0.5–0.8mm', door: 'Tempered Glass / Perforated', color: 'Black / Grey-White', notes: 'Shelf ×1 included' },
    ],
  },
  {
    id: 'wall-cabinet',
  ...
  },
  {
    ...
    products: [
      { model: 'NL-32U-800',  size: '600×800×1600 mm',  volume: '0.154 CBM', material: 'SPCC 1.2/1.0mm', door: 'Perforated (front & rear)', color: 'Black / Grey-White', notes: '800mm depth, dual-rail cable management' },
      { model: 'NL-37U-800',  size: '600×800×1800 mm',  volume: '0.173 CBM', material: 'SPCC 1.2/1.0mm', door: 'Perforated (front & rear)', color: 'Black / Grey-White', notes: '800mm depth' },
      { model: 'NL-42U-800',  size: '600×800×2000 mm',  volume: '0.192 CBM', material: 'SPCC 1.2/1.0mm', door: 'Perforated (front & rear)', color: 'Black / Grey-White', notes: '800mm depth' },
      { model: 'NL-42U-1000', size: '600×1000×2000 mm', volume: '0.240 CBM', material: 'SPCC 1.2/1.0mm', door: 'Perforated (front & rear)', color: 'Black / Grey-White', notes: '1000mm depth, heavy-duty server rack' },
      { model: 'NL-47U-1000', size: '600×1000×2200 mm', volume: '0.264 CBM', material: 'SPCC 1.2/1.0mm', door: 'Perforated (front & rear)', color: 'Black / Grey-White', notes: '1000mm depth' },
    ],
  },
  {
    id: 'server',
    ...
    products: [
      { model: 'SC-37U', size: '600×1000×1800 mm', volume: '0.216 CBM', material: 'SPCC 2.0/1.5mm', door: 'Perforated mesh (front & rear)', color: 'Black', notes: 'Load capacity 1000kg, 4-point leveling feet' },
      { model: 'SC-42U', size: '600×1000×2000 mm', volume: '0.240 CBM', material: 'SPCC 2.0/1.5mm', door: 'Perforated mesh (front & rear)', color: 'Black', notes: 'Load capacity 1000kg, 4-point leveling feet' },
      { model: 'SC-45U', size: '600×1000×2133 mm', volume: '0.256 CBM', material: 'SPCC 2.0/1.5mm', door: 'Perforated mesh (front & rear)', color: 'Black', notes: 'Load capacity 1200kg' },
      { model: 'SC-47U', size: '600×1000×2200 mm', volume: '0.264 CBM', material: 'SPCC 2.0/1.5mm', door: 'Perforated mesh (front & rear)', color: 'Black', notes: 'Load capacity 1200kg' },
    ],
  },
  {
    id: 'outdoor',
...
const specCols = ['Model', 'Dimensions (W×D×H)', 'Volume', 'Material', 'Door Options', 'Color', 'Notes']

export default function ServerRack() {
  return (
    <Layout
      title="Server Rack Manufacturer – 12U to 47U Floor & Wall Mount | Synstro"
      description="19-inch server rack enclosures, 6U–47U. SPCC cold-rolled steel, IP54/IP55 rated, powder-coated. Wall-mount, floor-standing, outdoor and server cabinet variants. OEM/ODM."
    >
      {/* Hero */}
      <section style={{ padding: '80px 0 60px', background: '#1a1f2e', borderBottom: '1px solid #2e3648' }}>
        <div className="container">
          <div style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#e8a020', marginBottom: 12 }}>
            Products / Server Racks
          </div>
          <nav style={{ fontSize: '0.82rem', color: '#4a5568', marginBottom: 24 }}>
            <Link href="/" style={{ color: '#4a5568' }}>Home</Link> › <Link href="/products/" style={{ color: '#4a5568' }}>Products</Link> › Server Racks
          </nav>
      ...
      {/* Series navigation */}
      <section style={{ background: '#111520', borderBottom: '1px solid #2e3648', padding: '0', overflowX: 'auto' }}>
        <div className="container" style={{ display: 'flex', gap: 0 }}>
          {series.map(s => (
            <a key={s.id} href={`#${s.id}`} style={{
              padding: '16px 20px', fontSize: '0.82rem', fontWeight: 600,
              color: '#8a94a6', whiteSpace: 'nowrap', borderBottom: '2px solid transparent',
      ...
      <section style={{ background: '#0d1117', padding: '80px 0', borderTop: '1px solid #2e3648' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 48, alignItems: 'center', flexWrap: 'wrap' }}>
          <div>
